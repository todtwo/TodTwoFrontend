    ...
    <>
      ...
      >
        <Grid container sx={{ height: "100%" }}>
          <Grid item xs={4} sx={{ height: "100%", padding: "5px" }}>
            <Slide in={true} direction="right" timeout={600}>
              ...
              >
                ...
                >
                  <Box sx={{ width: "100%" }}>Lent : 1</Box>
                  <Box sx={{ width: "100%" }}>Borrowed : 2</Box>
                </Box>
              </Grid>
            </Slide>
          </Grid>
            ...
            >
              <Slide in={true} direction="left" timeout={1000}>
                ...
                >
                  ...
                  >
                    <Tab
                      label={AccountTab.borrowed}
                      value={AccountTab.borrowed}
                      sx={{
                        color: "black !important",
                        ...(selectedTab == AccountTab.borrowed && {
                    ...
                    <Tab
                      label={AccountTab.lent}
                      value={AccountTab.lent}
                      sx={{
                        color: "black !important",
                        ...(selectedTab == AccountTab.lent && {
                          backgroundColor: "white",
                        }),
                      }}
                    />
